...
clusters by setting eigenvalues.num to a natural number.
...
fit is computed by kneepointDetection() function. 

Alternatively, by setting the flag one.line to true, another approach
